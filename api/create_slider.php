...
if (isset($_POST['title']) || isset($_POST['link']) || isset($_POST['content']) || isset($_POST['template']) || isset($_POST['position']) || isset($_POST['status']) || isset($_POST['file'])) {
    ...
    $size = $_FILES['file']['size'];
     ...
     if ($size > 10000000) { // file shouldn't be larger than 10Megabyte
        ...
        $post->template=$_POST['slidertemplate3'];
 ...
 */
        ...
        //create post
        if ($post->slider()) {
            $returnData = msg(1, 201, "Slider created.");
        } else {
            $returnData = msg(1, 422, "Slider not created.");
        }
